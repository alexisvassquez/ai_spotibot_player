...
# LED Mapping
def generate_lighting_profile(emotion_tags, output_path="audio/analysis_output/lighting_profile.json"):
    profile = []
    ...
    if emotion_tags:
        for mood in emotion_tags:
            bpm = 128 # can be dynamically calculated
            zone = "main" # "back_strip", "ceiling", etc.
